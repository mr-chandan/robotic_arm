#ifndef ROBOTIC_ARM_ARDUINO_ARDUINO_COMMS_HPP
#define ROBOTIC_ARM_ARDUINO_ARDUINO_COMMS_HPP
...
public:
  ...
  void set_motor_position(int val_1, int val_2, int val_3, int val_4)
  {
    std::stringstream ss;
